...
AGORA_NOTIFY_OBJ := $(BUILD_DIR)/agora_shm_ipc_notify.o
...
$(AGORA_NOTIFY_OBJ): src/agora_shm_ipc_notify.c src/agora_shm_ipc_notify.h src/agora_shm_ipc.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) -c src/agora_shm_ipc_notify.c -o $@
...
$(AGORA_WRITER): examples/agora_writer_demo.c $(AGORA_OBJ) $(AGORA_NOTIFY_OBJ) | $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ examples/agora_writer_demo.c $(AGORA_OBJ) $(AGORA_NOTIFY_OBJ) $(LIBS)

$(AGORA_READER): examples/agora_reader_demo.c $(AGORA_OBJ) $(AGORA_NOTIFY_OBJ) | $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ examples/agora_reader_demo.c $(AGORA_OBJ) $(AGORA_NOTIFY_OBJ) $(LIBS)
